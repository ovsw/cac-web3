<template>
  <div class="relative" @mouseover="showMenu" @mouseleave="hideMenu">
    ...
    <transition name="mega-menu-fade">
      <!-- v-show="isVisible" -->
      <div
        class="mega-menu absolute normal-case font-normal bg-light shadow-md rounded-lg overflow-hidden border mt-4 w-full lg:w-160 z-30 lg:z-10 left-0 lg:-left-16"
      >
              ...
              >
                ...
                <span class="ml-2">
                  <span
                    ...
                    >Test Missle Alert</span
                  >
                  <span
                    class="block text-sm text-gray-600 group-hover:text-blue-800"
                    >Probably meant to click this one</span
                  >
                </span>
              </a>
            </li>
            <li class="mb-8 lg:mb-0">
              ...
              >
                ...
                <span class="ml-2">
                  ...
                  <span
                    class="block text-sm text-gray-600 group-hover:text-blue-800"
                    >Create your own custom rules</span
                  >
                </span>
              </a>
            </li>
            ...
            <li class="">
              ...
              >
                ...
                <span class="ml-2">
                  ...
                  <span
                    class="block text-sm text-gray-600 group-hover:text-blue-800"
                    >Keep track of your growth</span
                  >
                </span>
              </a>
            </li>
          ...
          <li class="mb-6">
            ...
            >
              ...
              <span class="flex flex-col lg:flex-row lg:items-center">
                <span
                  class="block ml-2 font-bold text-blue-800 group-hover:text-blue-800"
                  >Full API Reference</span
                >
                <span
                  class="block ml-2 lg:ml-4 text-sm text-gray-600 group-hover:text-blue-800"
                  >Official libraries for our API</span
                >
              </span>
            </a>
          </li>
          <li>
            ...
            >
              ...
              <span class="flex flex-col lg:flex-row lg:items-center">
                ...
                <span
                  class="block ml-2 lg:ml-4 text-sm text-gray-600 group-hover:text-blue-800"
                  >Giving back to the community</span
                >
              </span>
            </a>
          </li>
